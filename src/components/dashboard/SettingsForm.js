...
const SettingsPage = () => {
  ...
  const handleNotificationChange = async (e) => {
    ...
    try {
      ...
      login({ ...user, emailNotifications: checked }, sessionStorage.getItem("token"), sessionStorage.getItem("sessionId"));
  ...
  // ✅ Corregido: manejo de privacidad
  const handlePrivacyChange = async (e) => {
    ...
    try {
      ...
      setSuccess(res.data.msg);
      login({ ...user, isPrivate: value }, sessionStorage.getItem("token"), sessionStorage.getItem("sessionId"));
